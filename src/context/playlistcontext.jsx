    ...
    const selectPlaylist = async (playlist) => {
        ...
        try {
            if (playlist.id === "liked-songs") {
                ...
                const trendingSongs = allSongs.filter(s => !s.uploaded_by || s.creator_email === 'admin@echord.com');
                ...
                const allSongs = await getSongs();
                const latestSongs = allSongs.filter(s => s.uploaded_by && s.creator_email !== 'admin@echord.com');
